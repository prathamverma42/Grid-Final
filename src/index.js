...
class ThankYouIQ extends React.Component{
  render(){
    return e(
      'div',{className:'chatting'},'Thank you for taking our IQ test '+'\n'+'Your Score is : '
    );
  }
}
...
class ThankYouSurvey extends React.Component{
  render(){
    return e(
      'div',{className:'chatting'},'Your Answers have been recorded '+'\n'+'Thank You For Giving The Survey'
    );
  }
}
...
class DOB extends React.Component{
  ...
  render(){
    return e(
      'div',{className:'Question'},
      <div id='image'><img src={logo} height={10}/><span>  GridBot</span></div>,
      e('div',{className:'chatting'},'Great going, now just enter your DOB'),
        e('DatePicker',{defaultValue:new Date(),valueFormat:{ dateStyle: "medium" }})
      );
  }
}
...
class Number extends React.Component{
  render(){
    return e(
      'div',{className:'Question'},
      <div id='image'><img src={logo} height={10}/><span>  GridBot</span></div>,
      e('div',{id:'Question 3'},e('div',{className:'chatting'},'Thank You, Now please Enter Your Number '))
    );
  }
}
...
function InputValues(){
  if(flag==1)
  {
    ...
    if(userString.length>0)
    {
      ...
      {sending.placeholder='Enter DOB : for eg - 23/09/2001';AddComponent(ids,DOB,'DOB');}
